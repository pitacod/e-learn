                            ...
                            <div class="row">
                                <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="col-lg-4 col-md-6">
                                        <div class="item">
                                            <div class="item-thumb"><img src="/assets/images/<?php echo e($course->image); ?>" alt="Item Thumbnail">
                                            </div><!-- /.item-thumb -->
                                            <div class="item-details">
                                                <h3 class="item-title"><a href="/courses/<?php echo e($course->id); ?>">
                                                ...
                                                <div class="details-bottom">
                                                  ...
                                                  <div><?php echo e($course->category->nom); ?></div>
                                            </div><!-- /.item-details -->
                    ...
                    <div class="col-md-4">
                        <aside class="sidebar">
                            <div class="category-list">
                                <ul>
                                    <li class="active"><a href="<?php echo e(route('courses.index')); ?>">All Courses</a></li>
                                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li><a href="<?php echo e(route('courses.showByCategory', $category->nom)); ?>"><?php echo e($category->nom); ?></a></li>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </ul>
                            </div>
                        </aside><!-- /.sidebar -->
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hamdi/Bureau/formation 2i g3/elearn/resources/views/course/index.blade.php ENDPATH**/ ?>